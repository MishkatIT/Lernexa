...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'The one content type with native Draft & Publish. Anonymous readers see published only.';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course owned by one instructor. Ownership for the whole tree resolves through course.instructor.';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One student in one course. Unique on (student, course) \u2014 DB index added in Phase 4.';
...
export interface ApiLessonCompletionLessonCompletion
  ...
  info: {
    description: 'The progress system. One row per (student, lesson) completed. No percentage is ever stored.';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A lesson within a course. Sequential viewing sorts by order ASC, id ASC.';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A historical record. totalQuestions and answers are a snapshot at submit time, never recomputed.';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'MCQ quiz for a course. find/findOne get disabled for students in Phase 5; they only get /take.';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'One row of typed platform config. Public read (the header needs siteName), admin-only write.';
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Lernexa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    blockedReason: Schema.Attribute.Text & Schema.Attribute.Private;
